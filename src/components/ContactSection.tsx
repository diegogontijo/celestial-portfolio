...
//           className="bento-card max-w-3xl mx-auto text-center"
//         >
//           <p className="text-xs font-mono text-primary uppercase tracking-widest mb-3">Contato</p>
//           <h2 className="text-4xl font-bold text-foreground mb-4">Vamos conversar?</h2>
//           <p className="text-muted-foreground mb-8 max-w-md mx-auto">
//             Lorem ipsum dolor sit amet, consectetur adipiscing elit. Entre em contato para discutir seu próximo projeto.
//           </p>
...
//             >
//               <Mail size={16} />
//               contato@diegogontijo.dev
//             </a>
//           </div>

//           <div className="flex items-center justify-center gap-4">
//             <a href="#" className="p-3 rounded-full border border-border text-muted-foreground hover:text-foreground hover:border-primary/40 transition-colors">
//               <Github size={20} />
//             </a>
//             <a href="#" className="p-3 rounded-full border border-border text-muted-foreground hover:text-foreground hover:border-primary/40 transition-colors">
//               <Linkedin size={20} />
    ...
    <section id="contact" className="py-24">
      <div className="container mx-auto px-6">
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.5 }}
          className="bento-card relative max-w-3xl mx-auto overflow-hidden text-center"
        >
